...
const MARKET_GROWER_COMFORT_RANGE: ComfortRange = { min: 26, max: 36 };
const MARKET_GROWER_COMFORT_ZONE = `${MARKET_GROWER_COMFORT_RANGE.min}-${MARKET_GROWER_COMFORT_RANGE.max}°C`;
  ...
  return (
    <div className="min-h-screen bg-white pb-10">
      ...
      <div className="px-5 relative z-10 max-w-7xl mx-auto space-y-5">
        ...
        {/* 2. รายงานอุณหภูมิ (Config MARKET) */}
              ...
              <>
                <div className="text-center mb-4">
                    <p className="text-xl font-medium text-[#054DD3]">
                      {buildTemperatureDeltaText(dashboardData?.summary?.airTemperatureC, MARKET_GROWER_COMFORT_RANGE)}
                    </p>
                    <p className="text-xl font-medium text-[#054DD3]">
        ...
        {/* 8. Action Buttons (Links updated for MARKET) */}
