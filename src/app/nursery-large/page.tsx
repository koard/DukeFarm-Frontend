  ...
  return (
    <div className="min-h-screen bg-white pb-10">
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              {showDropdown && (
                <div className="absolute right-0 top-full mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50">
                  <Link
                    href="/profile"
                    className="block w-full text-left px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-100 transition-colors flex items-center gap-2 rounded-t-lg"
                  >
                  ...
                  <button
                    ...
                    className="w-full text-left px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-100 transition-colors flex items-center gap-2 cursor-pointer rounded-b-lg"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="px-5 mt-4 relative z-10 max-w-7xl mx-auto space-y-5">
        ...
        <div className="mb-4">
          <span className="inline-flex items-center gap-2 bg-[#DB9DFF] text-purple-900 px-4 py-1.5 rounded-full text-sm font-bold shadow-sm border border-purple-200">
        ...
        {/* 1. ข้อมูลวันที่ & อุณหภูมิ */}
                ...
                <div className="flex items-center bg-[#FFEFBC] rounded-2xl overflow-hidden shadow-sm min-h-[100px]">
                    <div className="flex-1 p-4 flex flex-col items-center justify-center">
                        ...
                        <p className="text-xl font-bold text-black text-center">16-30</p>
                    </div>
                    ...
                    <div className="flex-1 p-4 flex flex-col items-center justify-center">
                        ...
                        <p className="text-xl font-bold text-black">1.5</p> 
                    </div>
                </div>
            ...
            <div className="pt-2 space-y-3 md:space-y-0 md:grid md:grid-cols-3 md:gap-4 md:col-span-2 lg:col-span-4">
                ...
                {/* Button 1: สภาพอากาศ */}
                <Link href="/nursery-large/weather-large" className="block w-full">
                ...
                {/* Button 2: การให้อาหาร */}
                <Link href="/nursery-large/feeding-large" className="block w-full">
                ...
                {/* Button 3: บันทึกข้อมูล */}
                <Link href="/nursery-large/record-large" className="block w-full">
