...
const SMALL_STAGE_COMFORT_ZONE = "28-34°C";
    ...
    <div className="min-h-screen bg-white pb-10">
      ...
      <div className="px-5 relative z-10 max-w-7xl mx-auto space-y-5">
        ...
        <div className="pt-2 space-y-3 md:space-y-0 md:grid md:grid-cols-3 md:gap-4 md:col-span-2 lg:col-span-4">
            ...
            <Link href="/nursery-small/price-small" className="block w-full">
            ...
            <Link href="/nursery-small/disease-info-small" className="block w-full">
            ...
            <Link href="/nursery-small/record-small" className="block w-full">
