...
const SMALL_STAGE_COMFORT_RANGE: ComfortRange = { min: 28, max: 34 };
const SMALL_STAGE_COMFORT_ZONE = `${SMALL_STAGE_COMFORT_RANGE.min}-${SMALL_STAGE_COMFORT_RANGE.max}°C`;
              ...
              <>
                <div className="text-center mb-4">
                    <p className="text-xl font-medium text-[#054DD3]">
                      {buildTemperatureDeltaText(dashboardData?.summary?.airTemperatureC, SMALL_STAGE_COMFORT_RANGE)}
                    </p>
                    <p className="text-xl font-medium text-[#054DD3]">
                ...
                <div>
                  ...
                  <p className="text-base text-black leading-relaxed">
                    หากอุณหภูมิน้ำอยู่ในช่วงที่เหมาะสม ({SMALL_STAGE_COMFORT_ZONE}) ปลามักจะกินอาหารและเจริญเติบโตได้ดี ควรเฝ้าดูแนวโน้มอุณหภูมิทุกวัน
                  </p>
                </div>
              </>
            )}
