  ...
  return (
    <div className="min-h-screen bg-white pb-10 relative">
      ...
      <div className="px-6 mt-6 w-full max-w-5xl mx-auto space-y-5">
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            <label className="block text-lg font-semibold text-black">ประเภทบ่อ</label>
        ...
        <div className="space-y-1">
          <div className="flex items-center justify-between">
            <label className="block text-lg font-semibold text-black">จำนวนบ่อ</label>
          </div>
        ...
        <div className="space-y-1">
          <div className="flex items-center justify-between">
            <label className="block text-lg font-semibold text-black">
              จำนวนปลาที่เลี้ยง <span className="text-gray-600 font-normal text-base">(ตัว)</span>
            </label>
          </div>
          <div className="bg-white border border-gray-300 rounded-2xl overflow-hidden">
            <input
        ...
        <div className="space-y-1">
          <div className="flex items-center justify-between">
            <label className="block text-lg font-semibold text-black">
              ปริมาณอาหาร <span className="text-gray-600 font-normal text-base">(กิโลกรัม)</span>
            </label>
          </div>
          <div className="bg-white border border-gray-300 rounded-2xl overflow-hidden">
            <input
